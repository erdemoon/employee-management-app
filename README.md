...
An Employee Management App built using LitElement with JavaScript.

## Core Features

- List all Employee Records either in Grid view or Table view.
- Search through Employee Records.
- Add a new Employee Record.
- Edit an existing Employee Record.
- Delete an existing Employee Record.
- Bulk Delete Employee Records through the Table view.
- Localization for TR and EN.
